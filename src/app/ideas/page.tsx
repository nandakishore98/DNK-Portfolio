...
const featureCards = [
  {
    ...
    color: "blue",
    description:
      "Rider types in English, driver sees it in Kannada. Instantly.",
    features: [
...
function BranchCard({
  ...
  item: (typeof customerBranches)[0];
  delay: number;
}) {
  ...
  return (
    <motion.div
      ...
      className={`relative rounded-xl border ${c.border} ${c.bg} p-5 hover:scale-[1.02] transition-transform duration-300`}
    >
  ...
  return (
    <motion.div
      ...
      className={`relative rounded-xl border ${
        card.ready ? c.border : "border-slate-800/60"
      } ${card.ready ? c.bg : "bg-slate-900/40"} p-6 hover:scale-[1.01] transition-transform duration-300`}
    >
      {/* number */}
      ...
      <div className="flex items-center gap-3 mt-2 mb-1">
        ...
        <h4
          className={`text-base font-semibold ${
            card.ready ? "text-slate-100" : "text-slate-500"
          }`}
        >
          {card.title}
        </h4>
    ...
    <div className="relative bg-slate-950 min-h-screen">
      ...
      <main className="pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <section className="mb-24">
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-[10px] font-semibold uppercase tracking-wider text-blue-400 bg-blue-500/10 border border-blue-500/20 px-2.5 py-0.5 rounded-full">
                  Idea 1
                </span>
              </div>
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-100 mt-3">
                Conversational Banking at Scale
              </h2>
              <p className="text-slate-400 mt-2 max-w-2xl leading-relaxed">
                Day-one use cases across conversational banking — a MECE framework
              </p>
            </motion.div>
          ...
          {/* ═══════════════════════════════════════
              IDEA 2 — Ride-Hailing Reimagined
             ═══════════════════════════════════════ */}
          <section>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-[10px] font-semibold uppercase tracking-wider text-orange-400 bg-orange-500/10 border border-orange-500/20 px-2.5 py-0.5 rounded-full">
                  Idea 2
                </span>
              </div>
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-100 mt-3">
                6 Gen AI Features Ride-Hailing Apps Should&apos;ve Shipped Yesterday
              </h2>
              <p className="text-slate-400 mt-2 max-w-2xl leading-relaxed">
                Ride-hailing apps optimize for bookings. Riders optimize for reaching on time.
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-lg font-semibold text-red-300">
                  Negotiation Disguised as Automation
                </h3>
              </div>
              <p className="text-sm text-slate-400 mb-6 max-w-xl leading-relaxed">
                The app shows ₹120. No driver accepts below ₹150. This isn&apos;t a pricing
                algorithm. It&apos;s theatre.
              </p>
