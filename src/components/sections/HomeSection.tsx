    ...
    <section id="home" className="relative py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <ScrollReveal delay={0.1}>
          <h2 className="text-3xl sm:text-4xl font-bold mb-10 text-slate-900 dark:text-slate-100">
            Where it all began
          </h2>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.15}>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-12">
            {achievements.map((a, i) => (
              <div
                key={i}
                className="rounded-xl border border-slate-200 dark:border-slate-800/80 bg-slate-50 dark:bg-slate-900/50 p-5 text-center hover:border-blue-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/5"
              >
            ...
            <ScrollReveal key={i} delay={0.1 * i}>
              ...
              <div className="flex flex-wrap gap-2">
                {cat.skills.map((skill) => (
                  <span
                    key={skill}
                    className="px-3 py-1.5 rounded-full text-sm border border-slate-200 dark:border-slate-700/80 bg-slate-100 dark:bg-slate-800/50 text-slate-700 dark:text-slate-300 hover:border-blue-500/40 hover:text-blue-400 transition-all duration-200"
                  >
                    {skill}
                  </span>
                ))}
        ...
        <ScrollReveal delay={0.25}>
          <div className="rounded-xl border border-slate-200 dark:border-slate-800/80 bg-slate-50 dark:bg-slate-900/50 p-8">
